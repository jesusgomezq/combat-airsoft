    ...
    <section>
      <div className="flex justify-center items-center h-screen">
        <div className="bg-gray-800 px-10 py-10 rounded-xl">
          <div>
            <h1 className="font-bold text-center text-xl text-gray-300 mb-4 font-titleFont capitalize">
              editar producto
            </h1>
          </div>
          <div>
          ...
          <div className="flex justify-between mb-3">
            <button className="border rounded-xl hover:bg-gray-300 text-gray-300 hover:text-gray-700 font-bold w-full py-2 px-2 capitalize font-titleFont"
