    ...
    <div className='bg-gray-600'>
        <div className='container mx-auto px-4'>
            <div className='p-5 rounded-lg'>
                <div className='relative group flex items-center w-44 ml-2 h-full'>
                    <SearchBar/>
                </div>
                <div className='flex items-center justify-between mt-4 text-gray-300'>
                    <p className='text-xl first-letter:uppercase'>filtrar</p>
                    <button className='px-4 py-2 text-xl first-letter:uppercase border border-gray-300 rounded-lg hover:bg-gray-400'>resetear filtro</button>
                </div>
                <div>
                    <div className='grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mt-4'>
                        <select className='px-4 py-3 w-full rounded-md outline-none bg-gray-100 focus:border-gray-500 text-md'>
                            <option value="rifles electricos">Rifles electrico</option>
