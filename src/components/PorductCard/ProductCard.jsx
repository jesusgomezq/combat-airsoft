    ...
    <section>
      <div className="container px-5 py-8 md:py-16 mx-auto">
        ...
        <div className="flex flex-wrap -m-4 px-4">
          <div className="p-4 w-full md:w-1/2 lg:w-1/3 xl:w-1/5 drop-shadow-lg">
          ...
          <div className="p-4 w-full md:w-1/2 lg:w-1/3 xl:w-1/5 drop-shadow-lg">
            <div className="h-full border-2 hover:shadow-gray-200 hover:shadow-2xl  transition-shadow duration-300 ease-in-out border-gray-300           border-opacity-75 rounded-2xl overflow-hidden">
              ...
              <div className="p-5 border-t-2">
                ...
                <div className="flex justify-center">
                  <button
                    className="text-gray-300 bg-gray-700 hover:bg-gray-900 font-medium rounded-lg w-full py-2 first-letter:uppercase duration-300 transition-all"
                    type="button">
                    agregar al carrito
                  </button>
                </div>
